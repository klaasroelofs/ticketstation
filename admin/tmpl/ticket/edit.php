                ...
                <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <?php if (isset($this->item->ticketid)?$this->item->ticketid:0 > 0)  { ?>
                            ...
                            <?php $remove_link_design = 'index.php?option=com_ticketstation&controller=ticket&task=removeDesign&ticketid='.$this->item->ticketid; ?>
                    ...
                    <div class="row mb-3">
                        <?php if (isset($this->item->ticketid)?$this->item->ticketid:0 > 0)  { ?>
                            ...
                            <?php $remove_link_bg = 'index.php?option=com_ticketstation&controller=ticket&task=removeBackground&ticketid='.$this->item->ticketid; ?>
